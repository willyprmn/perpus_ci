...
<body>
  <div class="col-md-4 col-md-offset-4" style="margin-top: 50px;">
    ...
    ?>
    <br>
    <div class="panel panel-default" style="background-color: #ccffe6">
      <div class="panel-body">
        <br><br>
      <form method="post" action="<?php echo base_url().'welcome/login' ?>">
        <div class="form-group">
          <label><span class="glyphicon glyphicon-user"></span> Username</label>
          <input type="text" name="admin_username" placeholder="Masukan Username" class="form-control">
          <?php echo form_error('username'); ?>
        </div>
        <div class="form-group">
          <label><span class="glyphicon glyphicon-lock"></span> Password</label>
          <input type="password" name="admin_password" placeholder="Masukan Password" class="form-control">
