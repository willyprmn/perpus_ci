<div class="page-header">
  <h3>Dashboard</h3>
  <a href="<?php echo base_url().'admin/table'; ?>">Link Tambahan</a>
  <a href="<?php echo base_url().'admin/table2'; ?>">Link Selanjutnya</a>
</div>
<div class="row">
          ...
          <div class="panel panel-warning">
            <div class="panel-heading">
              <div class="row">
                ...
                <div class="col-xs-9 text-right">
                  <div class="huge">
                    <font size="18"><b><?php echo $this->m_perpus->edit_data(array('status_peminjaman'=>'booking'),'peminjaman')->num_rows(); ?></b></font>
                  </div>
